...
import emhassAutomationYaml from "../../includes/emhass_automation.yaml?raw";
import emhassAutomationPatch from "../../includes/emhass_automation.patch?raw";

export const emhassAutomationYamlPatched = applyPatch(emhassAutomationYaml, emhassAutomationPatch) || emhassAutomationYaml;
...
<CodeBlock lang="yaml" code={emhassScriptYaml} />
...
<Tabs>
  <TabItem label="Amber Integration">
    <CodeBlock lang="yaml" code={emhassAutomationYaml} />
  </TabItem>
  <TabItem label="Amber2MQTT">
    <CodeBlock lang="yaml" code={emhassAutomationYamlPatched} />
  </TabItem>
</Tabs>
