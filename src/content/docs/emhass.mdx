...
import emhassA2MPatchYaml from "../../includes/emhass_script.patch?raw";
import emhassAutomationYaml from "../../includes/emhass_automation.yaml?raw";

export const emhassA2MScriptYaml = applyPatch(emhassAmberScriptYaml, emhassA2MPatchYaml) || emhassAutomationYaml;
