...
description: How to download and debug EMHASS script traces to verify sensor data and configuration.
---
...
Here is an <a href="/examples/trace%20script.generate_emhass_energy_plan_mpc%202025-11-23T08_57_37.319928+00_00.json">example trace</a> if you would like to compare.
